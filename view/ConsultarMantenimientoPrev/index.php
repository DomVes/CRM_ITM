...
<body class="with-side-menu">
	...
	<div class="page-content">
		<div class="container-fluid">
			...
			<a type="button" id="btnnuevo" href="../NuevoMantenimientoPrev/index.php" class="btn btn-inline btn-primary">Nuevo Registro</a>
			<div class="box-typical box-typical-padding">				
				<div class="row" id="viewuser">
					<div class="col-lg-2">
								<label class="form-label semibold" for="sede_id">Sede</label>
								<select class="select2" id="sede_id2" name="sede_id" >
                        		</select>
					</div>
					<div class="col-lg-2">
						<fieldset class="form-group">
							<label class="form-label" for="p_placa">Placa</label>
							<input type="number" class="form-control" id="p_placa2" name="p_placa" placeholder="Ingrese Placa" >
						</fieldset>
					</div>
					<div class="col-lg-2">
						<fieldset class="form-group">
							<label class="form-label" for="p_nomb">Nombre de equipo</label>
							<input type="search" class="form-control" id="p_nomb2" name="p_nomb" placeholder="Ingrese Nombre de Equipo" >
						</fieldset>
					</div>
					<div class="col-lg-2">
						<fieldset class="form-group">
						...
						<table id="mto_data" class="table table-bordered table-striped table-vcenter js-dataTable-full">
							<thead>
								<tr>									
									...
									<th class="text-center" style="width: auto;">Actualizar</th>
	...
	<script type="text/javascript" src="consultarmtopre.js"></script>	
