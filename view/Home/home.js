...
$(document).ready(function(){
    ...
    if ( $('#rol_idx').val() == 1){
        ...
        $.post("../../controller/preventivo.php?op=totalpreventivos", {usu_id:usu_id}, function (data) {
            data = JSON.parse(data);
            $('#lbltotalpreventivos').html(data.TOTAL);
        });
        $.post("../../controller/correctivo.php?op=totalcorrectivos", {usu_id:usu_id}, function (data) {
            data = JSON.parse(data);
            $('#lbltotalcorrectivos').html(data.TOTAL);
        });
