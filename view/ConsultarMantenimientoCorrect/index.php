...
<body class="with-side-menu">
	...
	<div class="page-content">
		<div class="container-fluid">
			...
			<a type="button" id="btnnuevo" href="../NuevoMantenimientoCorrect/index.php" class="btn btn-inline btn-primary">Nuevo Registro</a>
	...
	<script type="text/javascript" src="consultarmtocorrect.js"></script>	
